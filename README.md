...
A local development server, such as the VS Code Live Server extension, may also be used.

## Privacy and Repository Policy

This repository contains only the files required to operate the public website.

Original source photographs, personal backups, ZIP archives, private customer information, credentials, and other working files are intentionally stored outside the repository.

## Contact

M&M Handyman serves Sacramento and surrounding areas.

- Phone: (916) 509-0835
- Email: Jm03to18@gmail.com
